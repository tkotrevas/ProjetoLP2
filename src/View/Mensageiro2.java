...
public class Mensageiro2 extends javax.swing.JFrame {
...
Personagem personagem = new Personagem();
    ...
    public Personagem receberPersonagem(Personagem personagem, Mensageiro2 introducao){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        JOptionPane.showMessageDialog(null, "Parabéns jovem " + personagem.getRaca() + ". Você chegou na batalha final, que garantirá quem levará a chama.", "Knikell:", 1);
        JOptionPane.showMessageDialog(null, "Por ordem do reino, trouxe 3 itens para que possa usar diante desse duelo, ecolha sabiamente.", "Knikell:", 1);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Mensageiro2().setVisible(true);
